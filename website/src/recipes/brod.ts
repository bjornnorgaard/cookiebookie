...
export const brod: Recipe = {
    ...
    steps: [
        ...
        {title: "Olie og form", desc: "Hæld lidt olivenolie ned i kanten af skålen (indersiden) og lidt på bordet. Så arbejdes dejen forsigtigt ud af skålen. Den skal ikke æltes, bare lige foldes. Gør det nogle gange indtil den ligner en pæn dej med en stram overflade. Nu skal den hvile under et viskestykke eller en skål."},
        {title: "Bagetid", desc: "Du tænder ovnen på alt hvad den trække og forvarmer din støbejernsfætter. Vi mødes her igen om ~30 min."},
        {title: "Brænd nu ikke dine små dumme fingre", desc: "Sænk den så forsigtigt ned i din støbejernsgryde (pas nu på pølserne) og sprøjt den gavmildt til med vand. Sæt låg på og efterlad i ovnen i ca. 30 minutter før næste inspektion."},
        ...
        {title: "Skær den over på midten", desc: "Når du har ventet i en time, må du skære den over på midten og sende et billede til mor - det er vigtigt. Husk tandsmør, ost i tykke skiver og lidt salt!"},
    ],
};
