...
export const brod: Recipe = {
    ...
    steps: [
        ...
        {title: "Tjekketid", desc: "Kig til brødet. Hvis den ikke er færdig, sættes du den tilbage i ovnen. Hvis du er i tvivl, så spørger du en voksen."},
        ...
        {title: "Skær den over på midten", desc: "Hvis du har ventet en time, må du skære den over på midten og sende et billede til mor - det er vigtigt. Husk tandsmør, tykke skiver ost og lidt salt - selv tak!"},
    ],
};
